...
# Configuramos las columnas para que se estiren por igual
    ...
    def _crear_interfaz(self):
        ...
        entry_nombre=tb.Entry(frame_formulario)
        entry_nombre.grid(row=0,column=0,sticky="e")
        ...
        entry_precio=tb.Entry(frame_formulario)
        entry_precio.grid(row=1,column=0,sticky="e", pady=(10,5))
        ...
        entry_descripcion=tb.Entry(frame_formulario)
        entry_descripcion.grid(row=2,column=0,sticky="e",pady=(5,10))
        boton_anadir=tb.Button(frame_formulario, text="Añadir", bootstyle="[solid_button, dark]")
        boton_anadir.grid(row=3,column=0,sticky="ew")
        ...
        entry_buscar=tb.Entry(frame_buscar)
        entry_buscar.grid(row=0, column=0, sticky="ew", padx=10)
